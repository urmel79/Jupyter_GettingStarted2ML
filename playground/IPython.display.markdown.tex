\documentclass [oneside,10pt,a4paper,ngerman,BCOR10mm,headsepline,parindent,final]{scrartcl}
    ...
    % Document parameters
    % Document title
    \title{\textbf{\textsf{Test}}}\author{Dipl.-Ing. Bj\"orn Kasper (\href{mailto:kasper.bjoern@bgetem.de}{kasper.bjoern@bgetem.de})}\affil{Test and Certification Body for Electrical Engineering at BG ETEM}
\author[1]{Dipl.-Ing. Bj\"orn Kasper (\href{mailto:kasper.bjoern@bgetem.de}{kasper.bjoern@bgetem.de})}
\affil[1]{}
\author[2]{Dipl.-Ing. Bj\"orn Kasper (\href{mailto:kasper.bjoern@bgetem.de}{kasper.bjoern@bgetem.de})}
\affil[2]{}\date{\today; version 0.1}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/tmp/ipykernel\_6421/265042420.py:1: FutureWarning: In future versions
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df\PYZus{}styled} \PY{o}{=} \PY{n}{df}\PY{o}{.}\PY{n}{style}\PY{o}{.}\PY{n}{set\PYZus{}caption}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Test table rendered in markdown}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{display}\PY{p}{(}\PY{n}{Markdown}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{|    |   A |   B | }\PY{l+s+se}{\PYZbs{}}
\PY{l+s+s2}{                  |:\PYZhy{}\PYZhy{}\PYZhy{}|\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}:|\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}:| }\PY{l+s+se}{\PYZbs{}}
\PY{l+s+s2}{                  | a  |   1 |   1 | }\PY{l+s+se}{\PYZbs{}}
\PY{l+s+s2}{                  | a  |   2 |   2 | }\PY{l+s+se}{\PYZbs{}}
\PY{l+s+s2}{                  | b  |   3 |   3 |}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    ~~~\textbar{} A \textbar{} B \textbar{}
\textbar:---\textbar----:\textbar----:\textbar{} \textbar{} a \textbar{}
1 \textbar{} 1 \textbar{} \textbar{} a \textbar{} 2 \textbar{} 2
\textbar{} \textbar{} b \textbar{} 3 \textbar{} 3 \textbar{}
